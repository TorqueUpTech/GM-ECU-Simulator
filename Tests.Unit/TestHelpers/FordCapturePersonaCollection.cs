...
// FordCapturePersona is a singleton carrying process-wide mutable static state:
...
//
// Every test class that touches the FordCapturePersona singleton's statics
...
[CollectionDefinition(FordCapturePersonaCollection.Name)]
public sealed class FordCapturePersonaCollection
{
    public const string Name = "FordCapturePersona";
}
